...
class ASBIEImpl implements ASBIE {
	...
	override languageCode(Association umlAssociation) {
		ummStereotype.getStringValue(umlAssociation, "languageCode");
	}
	
	override usageRule(Association umlAssociation) {
		ummStereotype.getListOfStringValue(umlAssociation, "usageRule");
	}
