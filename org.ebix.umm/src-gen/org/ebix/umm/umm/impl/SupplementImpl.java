 ...
 * </p>
 * <ul>
 *   <li>{@link org.ebix.umm.umm.impl.SupplementImpl#getDefaultValue <em>Default Value</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.SupplementImpl#getRestriction <em>Restriction</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.SupplementImpl#getFixedValue <em>Fixed Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SupplementImpl extends BDTPropertyImpl implements Supplement
{
  /**
  ...
  {
    return UmmPackage.Literals.SUPPLEMENT;
  }
  ...
  public void setDefaultValue(String newDefaultValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.SUPPLEMENT__DEFAULT_VALUE, oldDefaultValue, defaultValue));
  }
  ...
  public EList<String> getRestriction()
  {
    if (restriction == null)
    {
      restriction = new EDataTypeEList<String>(String.class, this, UmmPackage.SUPPLEMENT__RESTRICTION);
    }
    return restriction;
  }
  ...
  public void setFixedValue(String newFixedValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.SUPPLEMENT__FIXED_VALUE, oldFixedValue, fixedValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmmPackage.SUPPLEMENT__DEFAULT_VALUE:
        return getDefaultValue();
      case UmmPackage.SUPPLEMENT__RESTRICTION:
        return getRestriction();
      case UmmPackage.SUPPLEMENT__FIXED_VALUE:
