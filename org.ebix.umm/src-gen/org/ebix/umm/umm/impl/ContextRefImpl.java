 ...
 * </p>
 * <ul>
 *   <li>{@link org.ebix.umm.umm.impl.ContextRefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContextRefImpl extends MinimalEObjectImpl.Container implements ContextRef
{
  ...
  {
    return UmmPackage.Literals.CONTEXT_REF;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.CONTEXT_REF__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmmPackage.CONTEXT_REF__NAME:
        return getName();
    }
