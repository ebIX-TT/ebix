...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BCC</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.ebix.umm.umm.impl.BCCImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.BCCImpl#getRestriction <em>Restriction</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.BCCImpl#getFixedValue <em>Fixed Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BCCImpl extends ACCPropertyImpl implements BCC
{
  /**
  ...
  {
    return UmmPackage.Literals.BCC;
  }
  ...
  public CDT getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      type = (CDT)eResolveProxy(oldType);
      if (type != oldType)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmmPackage.BCC__TYPE, oldType, type));
      }
    }
    return type;
  }
   ...
   * @generated
   */
  public void setType(CDT newType)
  {
    CDT oldType = type;
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.BCC__TYPE, oldType, type));
  }
  ...
  public EList<String> getRestriction()
  {
    if (restriction == null)
    {
      restriction = new EDataTypeEList<String>(String.class, this, UmmPackage.BCC__RESTRICTION);
    }
    return restriction;
  }
  ...
  public void setFixedValue(String newFixedValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.BCC__FIXED_VALUE, oldFixedValue, fixedValue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmmPackage.BCC__TYPE:
        if (resolve) return getType();
        return basicGetType();
      case UmmPackage.BCC__RESTRICTION:
        return getRestriction();
      case UmmPackage.BCC__FIXED_VALUE:
