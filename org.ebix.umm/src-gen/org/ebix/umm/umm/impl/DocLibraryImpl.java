...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Doc Library</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getUniqueIdentifier <em>Unique Identifier</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getVersionIdentifier <em>Version Identifier</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getBaseURN <em>Base URN</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getNamespacePrefix <em>Namespace Prefix</em>}</li>
 *   <li>{@link org.ebix.umm.umm.impl.DocLibraryImpl#getBieLibrary <em>Bie Library</em>}</li>
...
public class DocLibraryImpl extends LibraryImpl implements DocLibrary
{
  ...
  /**
   * The cached value of the '{@link #getBieLibrary() <em>Bie Library</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getBieLibrary()
   * @generated
   * @ordered
   */
  protected BIELibrary bieLibrary;
  ...
  /**
   * The cached value of the '{@link #getEnvelopes() <em>Envelopes</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getEnvelopes()
   * @generated
   * @ordered
   */
  protected EList<InfEnvelope> envelopes;
  ...
  {
    return UmmPackage.Literals.DOC_LIBRARY;
  }
  ...
  public EList<String> getBusinessTerm()
  {
    ...
    {
      businessTerm = new EDataTypeEList<String>(String.class, this, UmmPackage.DOC_LIBRARY__BUSINESS_TERM);
    }
    return businessTerm;
  }
  ...
  public EList<String> getCopyright()
  {
    if (copyright == null)
    {
      copyright = new EDataTypeEList<String>(String.class, this, UmmPackage.DOC_LIBRARY__COPYRIGHT);
    }
    return copyright;
  }
  ...
  public EList<String> getOwner()
  {
    if (owner == null)
    {
      owner = new EDataTypeEList<String>(String.class, this, UmmPackage.DOC_LIBRARY__OWNER);
    }
    return owner;
  }
  ...
  public EList<String> getReference()
  {
    if (reference == null)
    {
      reference = new EDataTypeEList<String>(String.class, this, UmmPackage.DOC_LIBRARY__REFERENCE);
    }
    return reference;
  }
  ...
  public void setUniqueIdentifier(String newUniqueIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__UNIQUE_IDENTIFIER, oldUniqueIdentifier, uniqueIdentifier));
  }
  ...
  public void setVersionIdentifier(String newVersionIdentifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__VERSION_IDENTIFIER, oldVersionIdentifier, versionIdentifier));
  }
  ...
  public void setBaseURN(String newBaseURN)
  {
    ...
    baseURN = newBaseURN;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__BASE_URN, oldBaseURN, baseURN));
  }
  ...
  public void setNamespacePrefix(String newNamespacePrefix)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__NAMESPACE_PREFIX, oldNamespacePrefix, namespacePrefix));
  }
   ...
   * @generated
   */
  public BIELibrary getBieLibrary()
  {
    if (bieLibrary != null && bieLibrary.eIsProxy())
    {
      InternalEObject oldBieLibrary = (InternalEObject)bieLibrary;
      bieLibrary = (BIELibrary)eResolveProxy(oldBieLibrary);
      if (bieLibrary != oldBieLibrary)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmmPackage.DOC_LIBRARY__BIE_LIBRARY, oldBieLibrary, bieLibrary));
      }
    }
    return bieLibrary;
  }
   ...
   * @generated
   */
  public BIELibrary basicGetBieLibrary()
  {
    return bieLibrary;
  }
   ...
   * @generated
   */
  public void setBieLibrary(BIELibrary newBieLibrary)
  {
    BIELibrary oldBieLibrary = bieLibrary;
    bieLibrary = newBieLibrary;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__BIE_LIBRARY, oldBieLibrary, bieLibrary));
  }
  ...
  public BDTLibrary getBdtLibrary()
  {
    if (bdtLibrary != null && bdtLibrary.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, UmmPackage.DOC_LIBRARY__BDT_LIBRARY, oldBdtLibrary, bdtLibrary));
      }
    }
    return bdtLibrary;
  }
  ...
  public void setBdtLibrary(BDTLibrary newBdtLibrary)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UmmPackage.DOC_LIBRARY__BDT_LIBRARY, oldBdtLibrary, bdtLibrary));
  }
   ...
   * @generated
   */
  public EList<InfEnvelope> getEnvelopes()
  {
    if (envelopes == null)
    {
      envelopes = new EObjectContainmentEList<InfEnvelope>(InfEnvelope.class, this, UmmPackage.DOC_LIBRARY__ENVELOPES);
    }
    return envelopes;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UmmPackage.DOC_LIBRARY__ENVELOPES:
        return ((InternalEList<?>)getEnvelopes()).basicRemove(otherEnd, msgs);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case UmmPackage.DOC_LIBRARY__BUSINESS_TERM:
        return getBusinessTerm();
      case UmmPackage.DOC_LIBRARY__COPYRIGHT:
        return getCopyright();
      case UmmPackage.DOC_LIBRARY__OWNER:
        return getOwner();
      case UmmPackage.DOC_LIBRARY__REFERENCE:
        return getReference();
      case UmmPackage.DOC_LIBRARY__UNIQUE_IDENTIFIER:
        return getUniqueIdentifier();
      case UmmPackage.DOC_LIBRARY__VERSION_IDENTIFIER:
        return getVersionIdentifier();
      case UmmPackage.DOC_LIBRARY__BASE_URN:
        return getBaseURN();
      case UmmPackage.DOC_LIBRARY__NAMESPACE_PREFIX:
        return getNamespacePrefix();
      case UmmPackage.DOC_LIBRARY__BIE_LIBRARY:
        if (resolve) return getBieLibrary();
        return basicGetBieLibrary();
      case UmmPackage.DOC_LIBRARY__BDT_LIBRARY:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case UmmPackage.DOC_LIBRARY__NAMESPACE_PREFIX:
        ...
        return;
      case UmmPackage.DOC_LIBRARY__BIE_LIBRARY:
        setBieLibrary((BIELibrary)newValue);
        return;
      case UmmPackage.DOC_LIBRARY__BDT_LIBRARY:
      ...
      case UmmPackage.DOC_LIBRARY__ENVELOPES:
        getEnvelopes().clear();
        getEnvelopes().addAll((Collection<? extends InfEnvelope>)newValue);
        return;
    }
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case UmmPackage.DOC_LIBRARY__BIE_LIBRARY:
        return bieLibrary != null;
      case UmmPackage.DOC_LIBRARY__BDT_LIBRARY:
        return bdtLibrary != null;
      case UmmPackage.DOC_LIBRARY__ENVELOPES:
        return envelopes != null && !envelopes.isEmpty();
    }
